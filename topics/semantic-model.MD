...
- Generic Trusted List REST API Specification
- LOTL List Of Trusted Lists with ETSI TS 119 612 format (eIDAS Qualified Trusted Service Providers)
- TRAIN
- EBSI
